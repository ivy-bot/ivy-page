...
require('./ParentECommerceTemplate.css')

export default class ParentECommerceTemplate extends React.Component {
    ...
    handleTitleChange = () => {
        let title = TemplateGenStore.getTitle()
    }

    handleDescriptionChange = () => {
        let description = TemplateGenStore.getDescription()
    }

    handleArticleChange = () => {
        let articles = TemplateGenStore.getArticles()
    }

    handleColorChange = () => {
        let color = TemplateGenStore.getColor()
    }
    ...
    render() {
        ...
        var title = "Buy some food"
        var description = "Eat like nobody is watching."

        return (
            <div className='h-100 overflow-auto bg-white'>
                <div className="cf pa2">
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/blonde/id1146195596?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/jeffery/id1146718343?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is1.mzstatic.com/image/thumb/Music71/v4/c8/2d/b1/c82db1cd-9dc5-d7cb-2a34-735cf47bb809/source/400x40000bb.png"
                                alt="Young Thug - Jeffery" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/untitled-unmastered./id1089846273?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/99.9/id1092026376?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is4.mzstatic.com/image/thumb/Music49/v4/e9/4c/2d/e94c2d5f-bdb0-c565-4cc2-f9dfcf7f0b87/source/400x40000bb.png"
                                alt="Kaytranada 99%" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/aa/id1067924003?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is3.mzstatic.com/image/thumb/Music49/v4/b6/b0/a1/b6b0a1dd-998d-9786-ca2f-87470be15250/source/400x40000bb.png"
                                alt="Baauer Aa - Album Cover" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/99-cents/id1054734475?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is3.mzstatic.com/image/thumb/Music62/v4/fa/ae/a6/faaea65f-0819-bb5d-afaa-4f5e84015204/source/400x40000bb.png"
                                alt="Santigold 99 cents - Album cover" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/a-moon-shaped-pool/id1111577743?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is2.mzstatic.com/image/thumb/Music18/v4/34/03/34/34033451-12e2-2d0b-c100-11a390922a01/source/400x40000bb.png"
                                alt="A Moon Shaped Pool - Album cover" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/the-life-of-pablo/id1123231885?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is3.mzstatic.com/image/thumb/Music20/v4/c0/98/d0/c098d05b-7bcc-0ea3-0213-0f69992fda65/source/400x40000bb.png"
                                alt="The Life of Pablo - Album Cover" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/coloring-book/id1113239004?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is2.mzstatic.com/image/thumb/Music18/v4/5a/42/0f/5a420f73-6490-abc9-bdcc-3001d5c4e9fc/source/400x40000bb.png"
                                alt="Coloring Book - Album cover" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
                    ...
                    <div className="fl w-50 w-25-m w-20-l pa2">
                        <a href="https://geo.itunes.apple.com/us/album/everybody-looking/id1135576036?at=1l3vqFJ&amp;mt=1&amp;app=music"
                           className="db link dim tc zoomIn">
                            <img
                                src="http://is4.mzstatic.com/image/thumb/Music30/v4/9b/2e/e1/9b2ee13e-35fd-0cc1-d203-e65b4beafc7f/source/400x40000bb.png"
                                alt="Everybody Looking - Album Cover" className="w-100 db outline black-10"/>
                            <dl className="mt2 f6 lh-copy">
                                <dt className="clip">Title</dt>
